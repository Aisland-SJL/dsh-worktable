...
export const css = xtermCss + '\n' + [
  ...
  '.dsh-wt_vbarLine{position:absolute;left:50%;transform:translate(-50%,-50%);width:13px;height:3px;padding:0;border:none;border-radius:2px;background:rgba(255,255,255,.95);cursor:pointer;z-index:2}',
