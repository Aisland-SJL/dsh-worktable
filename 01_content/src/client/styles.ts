...
export const css = xtermCss + '\n' + [
  ...
  '.dsh-wt_console[data-wt-theme=light] .dsh-wt_consoleCard{background:linear-gradient(135deg,rgba(255,255,255,1) 0%,rgba(255,255,255,.55) 30%,rgba(255,255,255,.12) 55%,rgba(31,41,55,.06) 100%),linear-gradient(115deg,rgba(255,255,255,0) 38%,rgba(255,255,255,.65) 46%,rgba(255,255,255,0) 56%),rgba(255,255,255,.34);box-shadow:0 10px 28px rgba(31,41,55,.18),inset 0 1px 0 rgba(255,255,255,1)}',
