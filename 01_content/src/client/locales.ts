...
export const zh = {
  ...
  'confirm.projectBody': '确定从工作台删除「{name}」？插件本身不会被卸载，之后可在「管理项目」→「恢复默认」找回。',
  'pane.browser': '浏览器',
  'pane.explorer': '资源管理器',
  'pane.scm': '源代码管理',
  'pane.tasks': '任务管理',
...
export const en = {
  ...
  'confirm.projectBody': 'Remove "{name}" from the worktable? The plugin stays installed; restore it later via Manage → Reset defaults.',
