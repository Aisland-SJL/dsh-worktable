/** 更新公告正文（v0.3.1 = v0.3.0 功能 + 发布包修复；呈现时按纯文本保留换行，不做 md 渲染） */
export const CHANGELOG_VERSION = 'v0.3.1'
export const CHANGELOG_V030 = `更新公告 · v0.3.1

🔧 本版本修复说明：v0.3.0 发布包存在打包缺陷（非标准 npm 包格式，安装时会报错导致插件无法加载），v0.3.1 已按标准格式重新打包。此前安装失败的用户，重新执行一次升级安装命令即可正常使用本版本。
