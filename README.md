...
| <img src="docs/assets/shot-1-sidebar.png" alt="Worktable sidebar" width="720"> | **🧩 Worktable sidebar** — the app drawer: projects, shortcuts and the pinned control-room entry |
